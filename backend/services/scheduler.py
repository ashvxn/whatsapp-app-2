...
def send_batch(app, campaign, contacts):
    """Send `campaign` to `contacts`, persisting a CampaignRecipient row (sent or
    failed) for each. Returns (sent_count, failed_count, total_cost). Shared by the
    scheduler and the campaign retry endpoint."""
    ...
    return sent_count, failed_count, total_cost
            ...
            try:
                ...
                for campaign in campaigns:
                    ...
                    try:
                        ...
                        sent_count, failed_count, total_campaign_cost = send_batch(app, campaign, contacts)
